...
public class DateUtil {
    ...
    public static String parseDateToChineseStr(Date time, String timeFromat) {
        DateFormat dateFormat = new SimpleDateFormat(timeFromat);
        return dateFormat.format(time);
    }
    public static String parseStrToChineseStr(String time, String timeFromat) {
        ...
        String yearstring=ChineseNumUtil.int2chineseYear(year);
